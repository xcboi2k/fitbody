        ...
        <ImageBackground source={require('@/assets/images/onboarding/onboarding-image-3.png')} 
            ...
            <View className='flex-1 items-center justify-center'>
                <View className='w-full p-[30px] bg-lightPurple items-center mb-[20px]'>
                    <Image source={require('@/assets/icons/nutrition-icon.png')} style={{ width: '30%', height: undefined, aspectRatio: 2, marginBottom: 15 }} resizeMode="contain" />
                    <Text className='text-white text-[20px] font-bold text-center mb-[15px]'>Find Nutrition Tips That Fit{'\n'}Your Lifestyle</Text>
