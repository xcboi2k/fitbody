...
export default function Onboarding2Screen() {
    ...
    return (
        <ImageBackground source={require('@/assets/images/onboarding/onboarding-image-2.png')} style={{ flex: 1 }} resizeMode="stretch">
            ...
            <View className='flex-1 items-center justify-center'>
                ...
                <OnboardingButton buttonText='Next' onClick={() => navigation.navigate('Onboarding', { screen: 'Onboarding3' })}/>
