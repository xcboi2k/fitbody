...
export default function NutritionScreen() {
    const navigation =
        useNavigation<NativeStackNavigationProp<NestedParamList>>()
        ...
        <View className="flex-1 items-center bg-black">
            ...
            <ScrollView className="w-full mb-[15px]">
                <View className="w-full flex-row justify-between items-center mb-[20px] px-[30px]">
                    ...
                    >
                        <Text
                            className={`text-[20px] text-center ${selected === 'Meal Plans' ? 'text-black' : 'text-lightPurple'}`}
                        >
                            Meal Plans
                        </Text>
                    </TouchableOpacity>
                    ...
                    >
                        <Text
                            className={`text-[20px] text-center ${selected === 'Meal Ideas' ? 'text-black' : 'text-lightPurple'}`}
                        >
                            Meal Ideas
                        </Text>
                    </TouchableOpacity>
                ...
                <View className="w-full p-[30px] bg-lightPurple items-center mb-[20px]">
                    <View className="bg-black w-full h-[200px] rounded-[20px] overflow-hidden">
                        ...
                        <View className="relative">
                            <Image
                                source={require('../../../../assets/images/food/carrot-orange-smoothie.jpg')} // Replace with your actual image
                        ...
                        <View className="px-[15px] py-[10px]">
                            ...
                            <View className="w-full flex flex-row items-center">
                                <View className="w-[80%] flex-col">
                                    <Text className="text-limeGreen text-[14px] font-bold mb-[5px]">
                ...
                <View className="w-full px-[30px] mb-[20px]">
                    <Text className="text-limeGreen text-[20px] mb-[5px]">
                        Recommended
                    </Text>
                    <View className="flex-row w-full justify-between items-center">
                        <View
                            className="w-[48%] border border-white rounded-[12px] p-2"
                            // key={bookmark.id}
                        >
                            {/* Event Image */}
                            <View className="relative">
                                <Image
                                    source={require('@/assets/images/food/fruit-smoothie.jpg')}
                            ...
                            <View className="mt-4">
                                <View className="flex-row justify-between items-start mb-[10px] w-full">
                                    <Text className="text-limeGreen text-[16px]">
                                        Fruit Smoothie
                                    </Text>
                                </View>
                        ...
                        >
                            ...
                            <View className="relative">
                                <Image
                                    source={require('@/assets/images/food/quinoa-salad.jpg')}
                                    className="h-40 w-full rounded-t-lg p-0"
                                />
                                <View className="absolute top-2 right-2">
                                    <AntDesign
                ...
                <View className="w-full px-[30px] mb-[20px]">
                    ...
                    <View
                        className="w-full bg-white rounded-[20px] flex-row mb-[20px]"
                        // key={bookmark.id}
                    >
                        ...
                        <View className="w-[50%] relative">
                            <Image
                                source={require('@/assets/images/food/delights-greek-yogurt.jpg')}
                    ...
                    >
                        ...
                        <View className="w-[50%] relative">
                            <Image
                                source={require('@/assets/images/food/baked-salmon.jpg')}
                                className="h-[110px] w-full rounded-[20px] p-0"
                            />
                            <View className="absolute top-2 right-2">
                                <AntDesign
